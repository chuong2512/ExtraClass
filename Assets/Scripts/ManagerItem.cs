...
public class ManagerItem : MonoBehaviour
{
	...
	[SerializeField] private GameObject assignedLayout;

	[SerializeField] private GameObject unassignLayout;
	...
	[SerializeField] private Text effectiveText;
	...
	public void Initialize(ManagerProfile profile)
	{
		...
		this.durationText,
		"Duration: "+GameUtilities.DateTime.Convert(Singleton<GameProcess>.Instance.GetManagerSkillDuration(profile.experience,profile.skill)));
		switch (profile.skill)
		{
			case ManagerSkill.UpgradeCost:
				GameUtilities.String.ToText(
				this.effectiveText,
				"-"+Singleton<GameProcess>.Instance.GetManagerSkillEffective(profile.experience,profile.skill)+"% Upgrade Cost");
				break;
			case ManagerSkill.WalkingSpeed:
				GameUtilities.String.ToText(
				this.effectiveText,
				"x"+Singleton<GameProcess>.Instance.GetManagerSkillEffective(profile.experience,profile.skill)+" Walking Speed");
				break;
			case ManagerSkill.CookingSpeed:
				GameUtilities.String.ToText(
				this.effectiveText,
				"x"+Singleton<GameProcess>.Instance.GetManagerSkillEffective(profile.experience,profile.skill)+" Cooking Speed");
				break;
			case ManagerSkill.LoadingSpeed:
				GameUtilities.String.ToText(
				this.effectiveText,
				"x"+Singleton<GameProcess>.Instance.GetManagerSkillEffective(profile.experience,profile.skill)+" Loading Speed");
				break;
			case ManagerSkill.MovementSpeed:
				GameUtilities.String.ToText(
				this.effectiveText,
				"x"+Singleton<GameProcess>.Instance.GetManagerSkillEffective(profile.experience,profile.skill)+" Movement Speed");
				break;
			case ManagerSkill.LoadExpansion:
				GameUtilities.String.ToText(
				this.effectiveText,
				"x"+Singleton<GameProcess>.Instance.GetManagerSkillEffective(profile.experience,profile.skill)+" Load Expansion");
				break;
		}
	}
