...
public class ManagerController : MonoBehaviour
{
	...
	private sealed class _Boosting_c__Iterator1 : IEnumerator,IDisposable,IEnumerator<object>
	{
		...
		public bool MoveNext()
		{
			...
			this._this.managerProfile.remainingTime=Singleton<GameProcess>.Instance.GetManagerSkillCooldown(
			this._this.managerProfile.experience,
			this._this.managerProfile.skill);
	...
	[HideInInspector] public ManagerProfile managerProfile;
	...
	public void ManagerAssign()
	{
		...
		{
			int managerSkillCooldown=
				Singleton<GameProcess>.Instance.GetManagerSkillCooldown(this.managerProfile.experience,this.managerProfile.skill);
		...
		{
			int managerSkillDuration=
				Singleton<GameProcess>.Instance.GetManagerSkillDuration(this.managerProfile.experience,this.managerProfile.skill);
			this.managerProfile.remainingTime=managerSkillDuration-num;
			if(this.managerProfile.remainingTime<=0)
			{
				this.managerProfile.remainingTime=Singleton<GameProcess>.Instance.GetManagerSkillCooldown(
				this.managerProfile.experience,
				this.managerProfile.skill);
