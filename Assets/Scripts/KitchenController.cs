...
public class KitchenController : MonoBehaviour
{
	...
	[NonSerialized] public KitchenData kitchenData;

	[NonSerialized] public KitchenProperties kitchenProperties;
	...
	public void ShowKitchenProperties() { Singleton<KitchenPopup>.Instance.Show(this); }
	...
	{
		int maxUpgradeLevel=Singleton<GameProcess>.Instance.GetMaxUpgradeLevel(
		cash,
		this.boostController.upgradeCostReduced,
		this.kitchenData.level,
		Location.Kitchen,
		this.kitchenData.floor);
