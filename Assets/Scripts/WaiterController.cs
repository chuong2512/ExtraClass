...
public class WaiterController : MonoBehaviour
{
		...
		public bool MoveNext()
		{
			...
			switch (num)
			{
				case 0u:
					...
					this._this.ApplyAnimationSpeed(
					2,
				...
				case 3u:
					...
					if(this._this.myselfTransform.localPosition!=this._this.gatheringPoint)
					{
						...
						this._this.myselfTransform.localPosition,
						this._this.gatheringPoint,
					...
					if(this._this.totalCashTransfer>0.0)
					{
						...
						this._current=new WaitForSeconds(
						(float) (this._this.totalCashTransfer/
			...
			IL_383:
			this._this.ApplyAnimationSpeed(
			(this._this.totalCashTransfer<=0.0) ? 5 : 3,
			this._this.restaurantController.boostController.walkingSpeedBoost);
			goto IL_456;
			IL_547:
	...
	private void Awake() { this.myselfTransform=base.transform; }
	...
	private void Rotate(bool b=true) { anim.transform.rotation=b ? Quaternion.identity : Quaternion.Euler(Vector3.up*180); }
}
